/*
 * Heart of Hearts Animation
 * Creates a large heart shape composed of many smaller, moving heart particles.
 */

const settings = {
	particles: {
		length: 500, // Number of particles
		duration: 2, // Particle life duration in seconds
		velocity: 100, // Particle velocity
		effect: -0.75, // Effect strength
